...
img=Image.open("BMI-CALCULATOR.png")
...
if st.checkbox("Blogging") or st.checkbox("Reading") or st.checkbox("Journaling") or st.checkbox("Hiking") or st.checkbox("Gardening") or st.checkbox("Other"):
    st.text("Selected!")
